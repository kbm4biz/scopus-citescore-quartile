...
<body>
  <main>
    ...
    <section data-language-panel="en">
      ...
      <p class="intro">Choose your browser, install Tampermonkey once, then install Scopus CiteScore Quartile.</p>
    ...
    <section data-language-panel="ar" lang="ar" dir="rtl" hidden>
      ...
      <p class="intro">اختر متصفحك، وثبّت <bdi dir="ltr">Tampermonkey</bdi> مرة واحدة، ثم ثبّت أداة أرباع <bdi dir="ltr">CiteScore</bdi>.</p>
